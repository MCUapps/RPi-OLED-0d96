...
void main(void)
{
  ...
  pinMode(6, OUTPUT);
  LCD_Init();
  LCD_P6x8Str(0,0,"RaspberryPi 0.96 OLED");
  LCD_P6x8Str(0,1,"128x64 by SSD1306 SPI");
  LCD_P8x16Str(0,2,"Designed by 52pi");
  LCD_P8x16Str(0,4,"Power Efficiency");
  LCD_P8x16Str(0,6,"Sold on MCUapps.");
}
